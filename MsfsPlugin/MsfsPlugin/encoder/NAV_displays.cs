...
// Uses ControllerValue so it updates immediately (mirrors COM logic).
...
namespace Loupedeck.MsfsPlugin
{
    ...
    internal static class NavDisplayFormat
    {
        ...
        {
            if (hz <= 0) return "000.00";
            var mhz = hz / 1_000_000.0;
            return mhz.ToString("000.00", CultureInfo.InvariantCulture);
        }
    }
    ...
    internal sealed class Nav1ActiveDisplay : DefaultEncoder
    {
        ...
        public Nav1ActiveDisplay() : base("NAV1 ACT", "NAV1 Active (display)", "RADIO_NAV", true, 0, 1, 1)
    ...
    internal sealed class Nav1StandbyDisplay : DefaultEncoder
    {
        ...
        public Nav1StandbyDisplay() : base("NAV1 STBY", "NAV1 Standby (display)", "RADIO_NAV", true, 0, 1, 1)
    ...
    {
        private readonly Binding _active;
        public Nav2ActiveDisplay() : base("NAV2 ACT", "NAV2 Active (display)", "RADIO_NAV", true, 0, 1, 1)
    ...
    {
        private readonly Binding _stby;
        public Nav2StandbyDisplay() : base("NAV2 STBY", "NAV2 Standby (display)", "RADIO_NAV", true, 0, 1, 1)
