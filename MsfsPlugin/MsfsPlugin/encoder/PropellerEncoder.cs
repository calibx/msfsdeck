namespace Loupedeck.MsfsPlugin
{
    ...
    class PropellerEncoder : DefaultEncoder
    {
        ...
        protected override Int32 GetValue() => MsfsData.Instance.CurrentPropeller;
        protected override void SetValue(Int32 newValue) => MsfsData.Instance.CurrentPropeller = newValue;
    }
}
