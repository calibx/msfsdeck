namespace Loupedeck.MsfsPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.MsfsPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.MsfsPlugin.Resources.Resource.txt`.
