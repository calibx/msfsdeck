/*
 * SimConnectCache from Mobiflight https://github.com/MobiFlight/MobiFlight-Connector/blob/main/SimConnectMSFS/SimConnectCache.cs
 */
namespace Loupedeck.MsfsPlugin.msfs.mobi
{
    ...
    public class SimConnectCache
    {
        ...
        public bool Connect()
        {
            DebugTracing.Trace("Mobi Connect");
        ...
        {
            DebugTracing.Trace("Mobi Aircraft info");
        ...
        {
            DebugTracing.Trace("Mobi Disconnect");
            ClearSimVars();
